...
class PutExample extends StatefulWidget {
  const PutExample({super.key});

  @override
  State<PutExample> createState() => _PutExampleState();
}

class _PutExampleState extends State<PutExample> {
  var oneController = TextEditingController();
  var twoController = TextEditingController();
  var threeController = TextEditingController();

  PostModal modal = PostModal.empty();
